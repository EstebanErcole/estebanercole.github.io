...
function nextItem() {
    ...
    // $previousSlide.find('.content-title, .content-subtitle').removeClass('animated');
...
function currentSlideTransition() {
    ...
    // $currentSlide.find('.content-title, .content-subtitle').addClass('animated');
    $("#logo img").attr('src', ($currentSlide.attr('id') == "services") ? 'images/w_logo_b.png' : 'images/w_logo_w.png');  
}